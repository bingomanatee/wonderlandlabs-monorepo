...
import { LeafIF } from './types/types.leaf';
import { CollectionDef, CollectionIF, DataID, DataValidatorFn, DoProps, TransAction, TransHandlerIF, TreeIF, UpdateMsg } from './types';
/**
...
export declare class Tree implements TreeIF {
    ...
    addCollection(config: CollectionDef, records?: []): void;
    private _indexes;
    ...
    query(query: QueryDef): import("rxjs").Observable<LeafIF[]>;
    fetch(query: QueryDef): any;
    findMatchingJoins(collection: string, coll2: string): any;
    leaf(collection: string, id: DataID, query?: QueryDefJoin): LeafIF;
