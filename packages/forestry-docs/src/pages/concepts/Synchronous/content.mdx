Asyncronous behavior is necessary when waiting for delayed action such as a
...
up by other processes to change or re-change the state in a seperate update pass.
