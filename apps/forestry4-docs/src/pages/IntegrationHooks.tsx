      ...
      <VStack spacing={8} align="stretch">
        ...
        <Section>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Text color="gray.600">
                The primary hook for subscribing to Forestry stores in React components.
                Automatically handles subscription lifecycle and provides reactive state updates.
              </Text>
              ...
              <Text>
                ...
                stores can be used in two contexts - locally to replace hooks, or globally, as in
                for a login/auth store, to replace Redux.
              </Text>
              <Text>
                <b>Local stores</b> expect a factory function that outputs a Store or Forest
                instance.
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Alert status="warning">
                ...
                <Box>
                  ...
                  <Text fontSize="sm" mt={1}>
                    This hook only observes forest changes. Use useForestBranch if you need to
                    create branches or modify forest state.
                  </Text>
                </Box>
              </Alert>
          ...
          <VStack spacing={6} align="stretch">
            ...
            <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6}>
              <Box layerStyle="card" bg="blue.50">
                ...
                <Text fontSize="sm">
                  Each form field gets its own branch with independent validation, error handling,
