    ...
    <Box maxW="6xl" mx="auto" p={6}>
      <VStack spacing={8} align="stretch">
        ...
        <Box textAlign="center">
          <Heading size="2xl" mb={4}>Schema Validation with Zod</Heading>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6}>
                <Box layerStyle="card" bg="green.50">
                  <Heading size="md" mb={2} color="green.700">Runtime Validation</Heading>
                  <Text fontSize="sm">
                ...
                <Box layerStyle="card" bg="blue.50">
                  <Heading size="md" mb={2} color="blue.700">Type Safety</Heading>
                  <Text fontSize="sm">
                ...
                <Box layerStyle="card" bg="purple.50">
                  <Heading size="md" mb={2} color="purple.700">Constraint Enforcement</Heading>
                  <Text fontSize="sm">
                ...
                <Box layerStyle="card" bg="orange.50">
                  <Heading size="md" mb={2} color="orange.700">Clear Error Messages</Heading>
                  <Text fontSize="sm">
                    Zod provides detailed, human-readable error messages that help developers
                    quickly identify and fix validation issues.
                  </Text>
                </Box>
              </SimpleGrid>
            </VStack>
        ...
        <Section>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Text color="gray.600">
                Define your state schema and use it as the <Code>schema</Code> property in Store constructor.
                Forestry will automatically validate state changes against this schema.
              </Text>
        ...
        <Section>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Text color="gray.600">
                While schemas handle structural validation, prep functions handle business logic
                and user input validation. They work together for comprehensive validation.
              </Text>
              ...
              <Alert status="info">
                ...
                <Box>
                  ...
                  <UnorderedList mt={2} spacing={1}>
                    <ListItem><strong>Schema:</strong> Structure, types, constraints (throws errors)</ListItem>
                    <ListItem><strong>Prep:</strong> Business rules, user input (sets quality feedback)</ListItem>
                  </UnorderedList>
                </Box>
              </Alert>
