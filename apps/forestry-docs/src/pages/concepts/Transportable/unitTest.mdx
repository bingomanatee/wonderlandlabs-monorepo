...
describe('concepts', () => {
  describe('transactional', () => {
    it('should rollback collections', () => {
      ...
      eggs.actions.removeADay();

      expect(eggs.value).toEqual(LESS_ONE_DAY);

      expect(() => eggs.actions.removeADay()).toThrow();

      expect(eggs.value).toEqual(LESS_ONE_DAY);

      eggs.actions.removeADayWithCatch();
    ...
    it('should observe change', () => {
      ...
      eggsCollection.actions.removeADay();
      eggsCollection.actions.removeADayWithCatch();
