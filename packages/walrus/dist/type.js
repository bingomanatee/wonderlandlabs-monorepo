...
class TypeDef {
     ...
     */
    get family() {
        if ([enums_1.FormEnum.scalar, enums_1.FormEnum.void, enums_1.FormEnum.function].includes(this.form)) {
            return this.form;
        }
...
exports.types = [
    new TypeDef(enums_1.TypeEnum.undefined, enums_1.FormEnum.void, enums_1.TypeofEnum.undefined),
    new TypeDef(enums_1.TypeEnum.null, enums_1.FormEnum.void, enums_1.TypeofEnum.object, (s) => s === null),
    new TypeDef(enums_1.TypeEnum.boolean, enums_1.FormEnum.scalar, enums_1.TypeofEnum.boolean),
    new TypeDef(enums_1.TypeEnum.string, enums_1.FormEnum.scalar, enums_1.TypeofEnum.string),
    new TypeDef(enums_1.TypeEnum.number, enums_1.FormEnum.scalar, enums_1.TypeofEnum.number),
    new TypeDef(enums_1.TypeEnum.number, enums_1.FormEnum.scalar, enums_1.TypeofEnum.bigint),
    new TypeDef(enums_1.TypeEnum.symbol, enums_1.FormEnum.scalar, enums_1.TypeofEnum.symbol),
    new TypeDef(enums_1.TypeEnum.function, enums_1.FormEnum.function, enums_1.TypeofEnum.function),
