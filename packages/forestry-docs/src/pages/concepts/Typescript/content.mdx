...
const t: treeIF<DataType> = f.addTree<DataType>('myTree', {initialValue: INITIAL});

// --- or ---

const coll : CollectionIF<DataType> = new Collection<DataType>('myColl', {initialValue: INITIAL});
