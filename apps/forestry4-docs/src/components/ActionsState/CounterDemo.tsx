...
import counterForestFactory from '@/storeFactories/counterStoreFactory.ts';
      ...
      <VStack spacing={4} align="stretch">
        <Box>
          ...
          <VStack spacing={3} align="stretch">
            <HStack>
              <Button colorScheme="forest" onClick={() => counterForest.$.increment()}>
              ...
              <Button colorScheme="blue" onClick={() => counterForest.$.doubleAndLog()}>
                Double
              </Button>
            </HStack>

            <HStack>
              <Button colorScheme="purple" onClick={() => counterForest.$.incrementTwice()}>
                +{counterState.multiplier * 2} (Twice)
              </Button>
              <Button variant="outline" onClick={() => counterForest.$.reset()}>
                Reset
              </Button>
            </HStack>
          </VStack>
        ...
        <Box>
          <FormControl>
            ...
            <Input
              ...
              onChange={(e) => counterForest.$.setMultiplier(parseInt(e.target.value) || 1)}
            />
          </FormControl>
        </Box>
      ...
      <VStack spacing={4} align="stretch">
        <Box>
          ...
          <Box p={4} bg="gray.50" borderRadius="md">
            <HStack mb={2}>
              ...
              <Badge
                colorScheme={
                  counterState.count === 0 ? 'gray' : counterState.count > 0 ? 'green' : 'red'
                }
                fontSize="lg"
              >
                {counterState.count}
        ...
        <Box>
          <Text fontSize="sm" color="gray.600">
            <strong>Try:</strong> Use different multipliers, try to exceed limits (-100 to +100), or
            set multiplier below 1 to see validation in action.
          </Text>
        </Box>
      </VStack>
    </SimpleGrid>
