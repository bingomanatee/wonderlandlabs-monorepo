...
exports.entitle = exports.capFirst = exports.humanize = exports.addAfter = exports.addBefore = void 0;
...
const entitle = (phrase) => {
    return (0, exports.humanize)(phrase).split(' ').map(exports.capFirst).join(' ');
};
