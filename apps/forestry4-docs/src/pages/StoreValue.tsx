    ...
    <Box maxW="6xl" mx="auto" p={6}>
      <VStack spacing={8} align="stretch">
        ...
        <Box textAlign="center">
          <Heading size="2xl" mb={4}>Store Value & Res Map</Heading>
          <Text fontSize="xl" color="gray.600" maxW="3xl" mx="auto">
            Understanding the store's value property and res map - their capabilities, 
            limitations, and proper usage patterns in Forestry stores.
          </Text>
        </Box>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Alert status="info">
                ...
                <Box>
                  ...
                  <Text fontSize="sm" mt={1}>
                    Store values are processed through Immer, providing immutable updates 
                    with mutable-style syntax in actions.
                  </Text>
                </Box>
              </Alert>
              ...
              <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6}>
                <Box layerStyle="card" bg="blue.50">
                  <Heading size="md" mb={2} color="blue.700">Immer Integration</Heading>
                  <Text fontSize="sm">
                    All state changes go through Immer's proxy system, enabling safe 
                    "mutations" that actually create new immutable versions.
                  </Text>
                </Box>
                
                <Box layerStyle="card" bg="purple.50">
                  <Heading size="md" mb={2} color="purple.700">No Prototype Preservation</Heading>
                  <Text fontSize="sm">
                    Class instances lose their prototypical inheritance. Store only 
                    plain data - objects, arrays, primitives, Maps, and Sets.
                  </Text>
                </Box>
                
                <Box layerStyle="card" bg="orange.50">
                  <Heading size="md" mb={2} color="orange.700">Flexible Value Types</Heading>
                  <Text fontSize="sm">
                    Values don't have to be objects. You can store primitives, arrays, 
                    Maps, Sets, or any JSON-serializable data structure.
                  </Text>
                </Box>
                
                <Box layerStyle="card" bg="red.50">
                  <Heading size="md" mb={2} color="red.700">No Reference Preservation</Heading>
                  <Text fontSize="sm">
                    Don't store DOM elements, functions, or objects that rely on 
                    reference equality. Immer creates new references on each update.
                  </Text>
                </Box>
              </SimpleGrid>
            </VStack>
        ...
        <Section>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Text color="gray.600">
                The <Code>res</Code> map is for storing complex, non-serializable objects that 
                actions need access to but shouldn't be part of the reactive state.
              </Text>

              <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6}>
                <Box layerStyle="card" bg="green.50">
                  <Heading size="md" mb={2} color="green.700">Non-Reactive Storage</Heading>
                  <Text fontSize="sm">
                    Changes to res don't trigger subscribers. It's a utility storage 
                    space for complex objects that actions need.
                  </Text>
                </Box>
                
                <Box layerStyle="card" bg="blue.50">
                  <Heading size="md" mb={2} color="blue.700">Any Value Type</Heading>
                  <Text fontSize="sm">
                    Store DOM elements, class instances, functions, or any complex 
                    object that can't be serialized in the main value.
                  </Text>
                </Box>
              </SimpleGrid>
