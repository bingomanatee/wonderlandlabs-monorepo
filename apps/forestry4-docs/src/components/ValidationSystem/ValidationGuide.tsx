    ...
    <Section>
      <VStack spacing={6} align="stretch">
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                tests are ran. It accepts a candidate value and returns a (potentially fixed) value.
                The purpose of pre is to catch "correctable" errors like data sorting, stringy
                numbers, or other minor flaws in prospective data. it is not <i>technically</i> a
                validator but it may prevent "mostly good" changes from being blocked on correctable
                issues
              </li>
              <li>
                <code>.schema</code> - managed by she schema property in the constructor params, it
                defines a Zod instance to define a schema that the state must follow; its basically
                parametric typescript - but unlike TS it is actually an enforced ruleset in React
                that dynamically blocks bad data from being entered in state.
              </li>

              <li>
                <code>.tests</code> - a function or array of functions that if they return a string
                or throw, prevent bad data from being saved into state; these test errors will throw
                to the outer scope; you may want to put catchers around code that might trigger
                tests. if tests is an array of functions, they are executed in order and any failure
                blocks subsequent tests from running.
              </li>
            </ol>
          </li>
          <li>
        ...
        <Box layerStyle="infoBox" bg="blue.50">
          ...
          <Text size="sm">
            again - data updating occurs <b>in this order</b>; if it matters, for instance, you can
            trust that your candidates conform to your schema before executing your tests.
          </Text>
        </Box>
